...
//        Produto produtoNovo = new Produto();
//        produtoNovo.setNome("Primeiro produto");
//        produtoNovo.setId(getContId(contId));
//        produtoNovo.setPreco("23,50");
//        estoqueLista.add(produtoNovo);

//        estoqueLista.forEach(produto -> System.out.println(produtoNovo.getNome()));
...
//        Integer id = Main.sc.nextInt();
//        Main.sc = new Scanner(System.in);
//        System.out.println("\tDigite [1] se deseja alterar o NOME\n\te [2] para alterar o PREÇO do produto.");
//        short escolha = Main.sc.nextShort();
//        switch (escolha){
//            case 1 -> {
//                Main.sc = new Scanner(System.in);
...
//                Estoque.estoqueLista.get(id-1).setNome(novoNome);
//
//            }
//            case 2 -> {
//                System.out.println("Qual o novo PREÇO do produto?");
//                BigDecimal novoPreco = Main.sc.nextBigDecimal();
//                Estoque.estoqueLista.get(id-1).setPreco(novoPreco);
//
//            }
//        }
//    }
    ...
    ////        tipoEscolhido.stripLeading();
    //        tipoEscolhido = Enum.valueOf(Musica.class);
    ...
    //        System.out.println(tipoEscolhido);

    //        ProdutosEnum produtosEnum = ProdutosEnum.valueOf(String.valueOf(Estoque.estoqueLista.get(id-1).getClass()));
